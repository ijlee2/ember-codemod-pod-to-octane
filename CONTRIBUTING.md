...
1. [Create a tag](https://github.com/ijlee2/ember-codemod-pod-to-octane/releases/new) and provide release notes. The tag name should match the package version (e.g. `0.1.2`).
