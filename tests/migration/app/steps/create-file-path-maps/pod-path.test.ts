...
import { inputProject } from '../../../../fixtures/app/pod-path/index.js';
import { normalizeFilePathMap } from '../../../../helpers/index.js';
import {
  codemodOptions,
  options,
} from '../../../../helpers/shared-test-setups/app/pod-path.js';
  ...
  assert.deepStrictEqual(
    ...
    normalizeFilePathMap(
      new Map([
        ...
        [
          'app/pods/application/serializer.js',
        ...
        [
          'app/pods/components/ui/form/component.js',
        ...
        [
          'app/pods/components/ui/form/styles.css',
          'app/components/ui/form.css',
        ],
        [
        ...
        [
          'app/pods/components/ui/page/styles.css',
        ...
        [
          'app/pods/product-details/styles.css',
          'app/styles/product-details.css',
        ],
        [
        ...
        [
          'app/pods/products/product/route.js',
  ...
  assert.deepStrictEqual(
    ...
    normalizeFilePathMap(
      new Map([
        ...
        [
          'tests/unit/pods/form/route-test.js',
