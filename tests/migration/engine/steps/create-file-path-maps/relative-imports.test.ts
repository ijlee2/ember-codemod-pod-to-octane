...
import { inputProject } from '../../../../fixtures/engine/relative-imports/index.js';
import {
  codemodOptions,
  options,
} from '../../../../helpers/shared-test-setups/engine/relative-imports.js';

test('migration | engine | steps | create-file-path-maps > relative-imports', function () {
